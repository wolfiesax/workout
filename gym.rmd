...
all1516 <- c(sum(all1516[,2]),myMean(all1516[,2],TRUE),
mySigma(all1516[,2],TRUE))
...
**Table `r paste(figr("tab3",type="table"), "", sep = ": ")`** *Total number of pushups starting from 2015 and onwards.*
